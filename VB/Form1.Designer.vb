...
Namespace SchedulerFetchCustomObjects
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' schedulerStorage1
			' 
'			Me.schedulerStorage1.FetchAppointments += New DevExpress.XtraScheduler.FetchAppointmentsEventHandler(Me.schedulerStorage1_FetchAppointments);
			' 
			' dateNavigator1
			' 
...
'			Me.cbBoldAppointmentDates.CheckedChanged += New System.EventHandler(Me.cbBoldAppointmentDates_CheckedChanged);
			' 
			' Form1
			' 
