...
#Region "#customeventlist"
    Public Class CustomEventList
        ...
        Default Public ReadOnly Property Item(ByVal idx As Integer) As CustomAppointment
            Get
                Return CType(List(idx), CustomAppointment)
            End Get
        End Property
        ...
        Public Function AddNew() As Object Implements IBindingList.AddNew
            Dim app As CustomAppointment = New CustomAppointment(Me)
            List.Add(app)
            Return app
        End Function
...
#Region "#customresourcecollection"
    Public Class CustomResourceCollection
        ...
        Default Public ReadOnly Property Item(ByVal idx As Integer) As CustomResource
            Get
                Return CType(List(idx), CustomResource)
            End Get
        End Property
...
#Region "IBindingList implementation"
        ...
        Friend Sub OnListChanged(ByVal args As ListChangedEventArgs)
            If listChangedHandler IsNot Nothing Then listChangedHandler(Me, args)
        End Sub
        ...
        Public Function AddNew() As Object Implements IBindingList.AddNew
            Dim res As CustomResource = New CustomResource()
            Add(res)
            Return res
        End Function
